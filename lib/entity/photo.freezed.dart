...
class _$PhotoTearOff {
  ...
  _Photo call(String url, int height, int width) {
    return _Photo(
      url,
      height,
      width,
...
class _$_Photo implements _Photo {
  _$_Photo(this.url, this.height, this.width);
  ...
  @override
  String toString() {
    return 'Photo(url: $url, height: $height, width: $width)';
  }
...
abstract class _Photo implements Photo {
  factory _Photo(String url, int height, int width) = _$_Photo;
